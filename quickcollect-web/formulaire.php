...
<form name="form_ques" method="POST" action="#" class="well">
  ...
  <div id="div_rub">
    <div>
      <input type="text" name="questionnaire" id="questionnaire" placeholder="Nom de votre Questionnaire">
    </div>
    <p></p>
    <div>
      <input type="text" name="rubrique" id="rubrique" placeholder="Nom de votre rubrique">
    </div>
    <div id="questions">
      <div id="div_ques_1">
        <table width="60%" align="center">
          <tr>
            <th><span>Titre de la question</span></th>
            <td><input id="ques_1" name="ques_1" placeholder="Nouvelle Question" style="text-align: left; " dir="ltr"></td>
          </tr>
          <tr>
            <th><span>Aide</span></th>
            <td><input id="aide_1" name="aide_1" placeholder="Consignes d'aide" style="text-align: left; " dir="ltr"></td>
          </tr>
          <tr>
            <th><span>Type de Question</span></th>
            <td><select name="sel_" id="sel_1" onChange="charger();">
              <?php 
        ...
        <p><span id="lien_new_ques"><a href="javascript:ajouter_question()"><img src="images/new_question.png" title="Nouvelle question"/>Ajouter une Question</a></span>
