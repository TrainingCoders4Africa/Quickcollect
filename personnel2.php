	...
	<div class="main">
		<nav>
			<ul id="menu">
				...
				<li class="nav2"><a href="#page_News">PERSONEL </a></li>
					...
					<div class="col1">
						<div class="ban1">
							<div class="pad">
								...
								<p>This is one of free web- site templates created by TemplateMonster.com team. This website template is optimized for 1024X768 screen res. Learn more about it <a href="http://blog.templatemonster.com/free-website-templates/ " target="_blank" rel="nofollow">here</a>.</p>
								<div class="center">
					...
					<div class="col1 pad_left1">
						<div class="ban2">
							<div class="pad">
								...
								<p>This Free Business Website Template goes with two packages – with PSD source files and without them. Learn more about it <a href="http://blog.templatemonster.com/2011/04/18/free-website-template-single-page-layout/" target="_blank" rel="nofollow">here</a>.<br><br></p>
								<div class="center">
									<a href="#" class="button1">Read More</a>
									<div class="button1_shadow"></div>
								</div>
									      ...
									      <div id="questions">
									        <div id="div_ques_1">
									          <table width="39%" align="center">
									            <tr>
									              <th colspan="2">Enregistrement Personnel</th>
								                </tr>
									            <tr>
									            ...
									            <tr>
									              <th><label for="fct">Fonction</label></th>
									              <td><input required="true" id="fct" name="fct" placeholder="Fonction" style="text-align: left; " dir="ltr"></td>
								                </tr>
									            <tr>
									          ...
									          <p>
									            <input class="btn btn-primary btn-large" type="submit" value="Valider" name="valider" id="valider"/>
